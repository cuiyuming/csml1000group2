...
# Try to impute the miss values
```{r}

dataset.pre <- preProcess(dataset[, c(5,9,10,11,12,13,14,15,16,18,19,21)], method = "bagImpute")

dataset.bagImpute <- dataset
dataset.bagImpute[, c(5,9,10,11,12,13,14,15,16,18,19,21)]  <- predict(dataset.pre,dataset.bagImpute[, c(5,9,10,11,12,13,14,15,16,18,19,21)])
